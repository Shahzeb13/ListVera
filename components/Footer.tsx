      ...
      <div className={styles.inner}>
        <div className={styles.top}>
          <h3 className={styles.heading}>
            Connect With <span className={styles.gold}>ListVera</span>
          </h3>
          <p className={styles.sub}>Your premier Web3 token listing and marketing agency.</p>

          <div className={styles.socials}>
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className={styles.social} aria-label="X / Twitter">
            ...
            <a href="https://telegram.org" target="_blank" rel="noopener noreferrer" className={styles.social} aria-label="Telegram">
              <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
            ...
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className={styles.social} aria-label="Discord">
              <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
        ...
        <div className={styles.bottom}>
          <p className={styles.copy}>© {year} ListVera. All rights reserved.</p>
